...
namespace EColiGif
{
  public class EColiGif : BaseApp
  {
    ...
    // start EcoliGif as an executable and run it, waiting for Siftrunner to connec
  }
}
*/
...
*/
  ...
  public class CubeWrapper {
	...
	public Boolean mNeedDrawIce = false;

    public CubeWrapper(EColiGif app, Cube cube) {
      mApp = app;
      mCube = cube;
      mCube.userData = this;
      mIndex = 0;
      ...
      mCube.Paint();
		...
		public void DrawIce ()
		{
			...
			Color color = new Color (r, g, b);
				mCube.FillRect (color , 0, 0, 39, 39);
				mCube.Paint ();
		}
